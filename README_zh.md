...
> *凡是我不能创造的，我就还没有理解。——理查德·费曼*

这是一种极佳的学习方式。

* [3D 渲染器](#从零构建你自己的-3d-渲染器)
* [AI 模型](#ai-模型)
* [增强现实](#从零构建你自己的增强现实)
* [BitTorrent 客户端](#从零构建你自己的-bittorrent-客户端)
* [区块链 / 加密货币](#从零构建你自己的区块链--加密货币)
* [机器人](#从零构建你自己的机器人)
* [命令行工具](#从零构建你自己的命令行工具)
* [数据库](#从零构建你自己的数据库)
* [Docker](#从零构建你自己的-docker)
* [模拟器 / 虚拟机](#从零构建你自己的模拟器--虚拟机)
* [前端框架 / 库](#从零构建你自己的前端框架--库)
* [游戏](#从零构建你自己的游戏)
* [Git](#从零构建你自己的-git)
* [内存分配器](#从零构建你自己的内存分配器)
* [网络栈](#从零构建你自己的网络栈)
...
* [处理器](#从零构建你自己的处理器)
* [编程语言](#从零构建你自己的编程语言)
* [正则表达式引擎](#从零构建你自己的正则表达式引擎)
* [搜索引擎](#从零构建你自己的搜索引擎)
* [Shell](#从零构建你自己的-shell)
* [模板引擎](#从零构建你自己的模板引擎)
* [文本编辑器](#从零构建你自己的文本编辑器)
* [视觉识别系统](#从零构建你自己的视觉识别系统)
* [体素引擎](#从零构建你自己的体素引擎)
* [Web 浏览器](#从零构建你自己的-web-浏览器)
* [Web 服务器](#从零构建你自己的-web-服务器)
* [其他](#其他)

## 教程

#### 从零构建你自己的 `分布式系统`
* [**Java**: _从零构建类 Kafka 系统：循序渐进指南_](https://github.com/buildthingsuseful/build-your-own-kafka)
...
* [**C++**: _OpenGL 是如何工作的：500 行代码实现软件渲染_](https://github.com/ssloy/tinyrenderer/wiki)
* [**C++**: _Wolfenstein 3D 的光线投射引擎_](http://lodev.org/cgtutor/raycasting.html)
* [**C++**: _基于物理的渲染：从理论到实现_](http://www.pbr-book.org/)
* [**C++**: _一个周末学完光线追踪_](https://raytracing.github.io/books/RayTracingInOneWeekend.html)
* [**C++**: _光栅化：实践实现_](https://www.scratchapixel.com/lessons/3d-basic-rendering/rasterization-practical-implementation/overview-rasterization-algorithm)
* [**C# / TypeScript / JavaScript**: _用 C#、TypeScript 或 JavaScript 从零编写 3D 软引擎教程系列_](https://www.davrous.com/2013/06/13/tutorial-series-learning-how-to-write-a-3d-soft-engine-from-scratch-in-c-typescript-or-javascript/)
...
* [**JavaScript / 伪代码**: _从零开始学计算机图形学_](http://www.gabrielgambetta.com/computer-graphics-from-scratch/introduction.html)
* [**Python**: _3D 建模器_](http://aosabook.org/en/500L/a-3d-modeller.html)

#### AI 模型
* [**Python**: _大语言模型（LLM）_](https://github.com/rasbt/LLMs-from-scratch)
* [**Python**: _用于图像生成的扩散模型_](https://huggingface.co/learn/diffusion-course/en/unit1/3)
* [**Python**: _用于文档检索的 RAG_](https://github.com/langchain-ai/rag-from-scratch)

#### 从零构建你自己的`增强现实`

* [**C#**: _如何：使用 Vuforia 和 Unity 3D 制作增强现实应用初学者教程_](https://www.youtube.com/watch?v=uXNjNcqW4kY) [视频]
* [**C#**: _Unity ARCore 教程_](https://www.youtube.com/playlist?list=PLKIKuXdn4ZMjuUAtdQfK1vwTZPQn_rgSv) [视频]
* [**C#**: _Unity AR 传送门教程_](https://www.youtube.com/playlist?list=PLPCqNOwwN794Gz5fzUSi1p4OqLU0HTmvn) [视频]
* [**C#**: _如何在 Unity ARCore 中创建增强现实龙_](https://www.youtube.com/watch?v=qTSDPkPyPqs) [视频]
* [**C#**: _增强现实 AR 教程：ARKit 传送门_](https://www.youtube.com/watch?v=Z5AmqMuNi08) [视频]
...
#### 从零构建你自己的 `BitTorrent 客户端`

* [**C#**: _用 C# 从零构建 BitTorrent 客户端_](https://www.seanjoflynn.com/research/bittorrent.html)
* [**Go**: _用 Go 从底层构建 BitTorrent 客户端_](https://blog.jse.li/posts/torrent/)
...
* [**Python**: _用 Python 3.5 实现 BitTorrent 客户端_](http://markuseliasson.se/article/bittorrent-in-python/)

#### 从零构建你自己的`区块链 / 加密货币`

* [**ATS**: _函数式区块链_](https://beta.observablehq.com/@galletti94/functional-blockchain)
* [**Crystal**: _用 Crystal 编写你自己的区块链和 PoW 算法_](https://medium.com/@bradford_hamilton/write-your-own-blockchain-and-pow-algorithm-using-crystal-d53d5d9d0c52)
* [**Go**: _用 Go 构建区块链_](https://jeiwan.net/posts/building-blockchain-in-go-part-1/)
* [**Go**: _不超过 200 行 Go 代码实现区块链_](https://medium.com/@mycoralhealth/code-your-own-blockchain-in-less-than-200-lines-of-go-e296282bcffc)
...
* [**JavaScript**: _不超过 1500 行代码实现一个加密货币_](https://github.com/conradoqg/naivecoin)
...
* [**JavaScript**: _用 JavaScript 创建一条区块链_](https://github.com/SavjeeTutorials/SavjeeCoin)
* [**JavaScript**: _如何上线你自己的生产就绪加密货币_](https://hackernoon.com/how-to-launch-your-own-production-ready-cryptocurrency-ab97cb773371)
* [**JavaScript**: _在 Node.js 中编写区块链_](https://www.smashingmagazine.com/2020/02/cryptocurrency-blockchain-node-js/)
* [**Kotlin**: _用 Kotlin 实现一个加密货币_](https://medium.com/@vasilyf/lets-implement-a-cryptocurrency-in-kotlin-part-1-blockchain-8704069f8580)
* [**Python**: _通过构建区块链来学习区块链_](https://hackernoon.com/learn-blockchains-by-building-one-117428612f46)
* [**Python**: _构建你自己的区块链：Python 教程_](http://ecomunsing.com/build-your-own-blockchain)
* [**Python**: _用 Python 实践区块链入门_](http://adilmoujahid.com/posts/2018/03/intro-blockchain-bitcoin-python/)
* [**Python**: _构建最小的区块链_](https://medium.com/crypto-currently/lets-build-the-tiniest-blockchain-e70965a248b)
* [**Ruby**: _循序渐进编程区块链（手稿书籍版）_](https://github.com/yukimotopress/programming-blockchains-step-by-step)
* [**Scala**: _如何构建简单的基于 Actor 的区块链_](https://medium.freecodecamp.org/how-to-build-a-simple-actor-based-blockchain-aac1e996c177)
* [**TypeScript**: _Naivecoin：构建加密货币教程_](https://lhartikk.github.io/)
* [**TypeScript**: _NaivecoinStake：构建基于权益证明共识的加密货币教程_](https://naivecoinstake.learn.uno/)
...
* [**Node.js**: _如何制作响应式 Telegram 机器人_](https://www.sohamkamani.com/blog/2016/09/21/making-a-telegram-bot/)
...
* [**Node.js**: _使用 Web Speech API 和 Node.js 构建简单 AI 聊天机器人_](https://www.smashingmagazine.com/2017/08/ai-chatbot-web-speech-api-node-js/)
* [**Python**: _如何用 Python 构建你的第一个 Slack 机器人_](https://www.fullstackpython.com/blog/build-first-slack-bot-python.html)
* [**Python**: _如何在 20 分钟内用 Python Slack Events API 和 Django 构建 Slack 机器人_](https://medium.com/freehunch/how-to-build-a-slack-bot-with-python-using-slack-events-api-django-under-20-minute-code-included-269c3a9bf64e)
* [**Python**: _构建 Reddit 机器人_](https://pythonforengineers.com/blog/build-a-reddit-bot-part-1/)
...
* [**Python**: _用 Python 和 Tweepy 创建 Twitter 机器人_](https://medium.freecodecamp.org/creating-a-twitter-bot-in-python-with-tweepy-ac524157a607)
* [**Python**: _用 Python 和 PRAW 创建 Reddit 机器人_](https://www.youtube.com/playlist?list=PLIFBTFgFpoJ9vmYYlfxRFV6U_XhG-4fpP) [视频]
* [**R**: _用 R 构建加密货币交易机器人_](https://towardsdatascience.com/build-a-cryptocurrency-trading-bot-with-r-1445c429e1b1)
* [**Rust**: _用 Rust、C 或其他语言为星际争霸创建机器人_](https://habr.com/en/post/436254/)
...
* [**Nim**: _编写用于管理 dotfiles 的 stow 替代品_](https://xmonader.github.io/nimdays/day06_nistow.html)
* [**Node.js**: _用 JavaScript 创建 CLI 工具_](https://citw.dev/tutorial/create-your-own-cli-tool)
* [**Rust**: _用 Rust 编写命令行应用_](https://rust-cli.github.io/book/index.html)
* [**Rust**: _用 Rust 编写命令行工具_](https://mattgathu.dev/2017/08/29/writing-cli-app-rust.html)
* [**Zig**: _从零用 Zig 构建你自己的 CLI 应用_](https://rebuild-x.github.io/docs/#/./zig/terminal/cli)


#### 从零构建你自己的`数据库`

* [**C**: _构建一个简单的数据库_](https://cstack.github.io/db_tutorial/)
...
* [**Go**: _从零构建你自己的数据库：从 B+ 树到 SQL，3000 行代码_](https://build-your-own.org/database/)
* [**Go**: _45 步编写一个数据库：一系列测试驱动的小型编程谜题_](https://trialofcode.org/database/)
...
* [**Python**: _DBDB：Dog Bed 数据库_](http://aosabook.org/en/500L/dbdb-dog-bed-database.html)
...
* [**Go**: _从零用 Go 构建容器_](https://www.youtube.com/watch?v=8fi7uSYlOdc) [视频]
* [**Python**: _Linux 容器工作坊：从零重建 Docker_](https://github.com/Fewbytes/rubber-docker)
* [**Python**: _用 100% Python 实现的 Docker 概念验证仿制品_](https://github.com/tonybaloney/mocker)
* [**Shell**: _约 100 行 bash 实现 Docker_](https://github.com/p8952/bocker)

#### 从零构建你自己的`模拟器 / 虚拟机`

* [**C**: _自制字节码解释器_](https://medium.com/bumble-tech/home-grown-bytecode-interpreters-51e12d59b25c)
* [**C**: _用 C 实现虚拟机_](http://web.archive.org/web/20200121100942/https://blog.felixangell.com/virtual-machine-in-c/)
...
* [**C++**: _从零构建 NES 模拟器_](https://www.youtube.com/playlist?list=PLrOv9FMX8xJHqMvSGB_9G9nZZ_4IgteYf) [视频]
* [**Common Lisp**: _用 Common Lisp 实现 CHIP-8_](http://stevelosh.com/blog/2016/12/chip8-cpu/)
* [**JavaScript**: _JavaScript 实现 GameBoy 模拟_](http://imrannazar.com/GameBoy-Emulation-in-JavaScript)
* [**Python**: _模拟基础：编写你自己的 Chip 8 模拟器/解释器_](http://omokute.blogspot.com.br/2012/06/emulation-basics-write-your-own-chip-8.html)
* [**Rust**: _0dmg：通过构建局部 Game Boy 模拟器学习 Rust_](https://jeremybanks.github.io/0dmg/)

#### 从零构建你自己的`前端框架 / 库`

* [**JavaScript**: _JSX 是什么（让我们构建一个 JSX 渲染器）_](https://jasonformat.com/wtf-is-jsx/)
* [**JavaScript**: _构建你自己的 React 的 DIY 指南_](https://github.com/hexacta/didact)
* [**JavaScript**: _从零构建 React_](https://www.youtube.com/watch?v=_MAD4Oly9yg) [视频]
* [**JavaScript**: _Gooact：160 行 JavaScript 实现 React_](https://medium.com/@sweetpalma/gooact-react-in-160-lines-of-javascript-44e0742ad60f)
* [**JavaScript**: _通过构建轻量级 React DOM 理解 React Reconciler 包的工作原理_](https://hackernoon.com/learn-you-some-custom-react-renderers-aed7164a4199)
* [**JavaScript**: _自己构建一个 Redux_](https://zapier.com/engineering/how-to-build-redux/)
* [**JavaScript**: _让我们来写 Redux！_](https://www.jamasoftware.com/blog/lets-write-redux/)
...
* [**JavaScript**: _打造你自己的 AngularJS_](http://teropa.info/blog/2013/11/03/make-your-own-angular-part-1-scopes-and-digest.html)
* [**JavaScript**: _如何编写你自己的虚拟 DOM_](https://medium.com/@deathmood/how-to-write-your-own-virtual-dom-ee74acc13060)
* [**JavaScript**: _从零构建前端框架，包含组件（模板、状态、VDOM）_](https://mfrachet.github.io/create-frontend-framework/)
...
* [**C**: _如何用 C 为 NES 编程_](https://nesdoug.com/)
* [**C**: _用 C 实现国际象棋引擎_](https://www.youtube.com/playlist?list=PLZ1QII7yudbc-Ky058TEaOstZHVbT-2hg) [视频]
* [**C**: _一起来制作：危险的戴夫_](https://www.youtube.com/playlist?list=PLSkJey49cOgTSj465v2KbLZ7LMn10bCF9) [视频]
* [**C**: _用 C 学习视频游戏编程_](https://www.youtube.com/playlist?list=PLT6WFYYZE6uLMcPGS3qfpYm7T_gViYMMt) [视频]
...
* [**C++**: _平台无关、面向初学者的 C++ 俄罗斯方块教程_](http://javilop.com/gamedev/tetris-tutorial-in-c-platform-independent-focused-in-game-logic-for-beginners/)
* [**C++**: _用 C++ 重制 Cavestory_](https://www.youtube.com/watch?v=ETvApbD5xRo&list=PLNOBk_id22bw6LXhrGfhVwqQIa-M2MsLa) [视频]
* [**C++**: _重建 Cave Story_](https://www.youtube.com/playlist?list=PL006xsVEsbKjSKBmLu1clo85yLrwjY67X) [视频]
* [**C++**: _从零构建太空侵略者_](http://nicktasios.nl/posts/space-invaders-from-scratch-part-1.html)
...
* [**Go**: _用 Go 开发游戏_](https://www.youtube.com/playlist?list=PLDZujg-VgQlZUy1iCqBbe5faZLMkA3g2x) [视频]
* [**Java**: _用 Java 编写 2D 游戏引擎——初学者完整课程_](https://www.youtube.com/watch?v=025QFeZfeyM) [视频]
* [**Java**: _使用 LWJGL 3 进行 3D 游戏开发_](https://lwjglgamedev.gitbooks.io/3d-game-development-with-lwjgl/content/)
* [**JavaScript**: _使用 Phaser 制作 2D 打砖块游戏_](https://developer.mozilla.org/en-US/docs/Games/Tutorials/2D_breakout_game_Phaser)
* [**JavaScript**: _如何用 Phaser 在 HTML5 中制作 Flappy Bird_](http://www.lessmilk.com/tutorial/flappy-bird-phaser-1)
* [**JavaScript**: _用 React、Redux 和 SVG 开发游戏_](https://auth0.com/blog/developing-games-with-react-redux-and-svg-part-1/)
* [**JavaScript**: _从零构建你自己的 8 球台球游戏_](https://www.youtube.com/watch?v=aXwCrtAo4Wc) [视频]
...
* [**JavaScript**: _像程序员一样思考：如何只用 JavaScript、HTML 和 CSS 构建贪吃蛇_](https://medium.freecodecamp.org/think-like-a-programmer-how-to-build-snake-using-only-javascript-html-and-css-7b1479c3339e)
...
* [**Rust**: _Rust 冒险：基础 2D 游戏_](https://a5huynh.github.io/posts/2018/adventures-in-rust/)
* [**Rust**: _Rust + tcod Roguelike 教程_](https://tomassedovic.github.io/roguelike-tutorial/)

#### 从零构建你自己的 `Git`

* [**Haskell**: _从底层用 Haskell 重新实现 "git clone"_](http://stefan.saasen.me/articles/git-clone-in-haskell-from-the-bottom-up/)
...
* [**Python**: _刚好够用的 Git 客户端：创建仓库、提交并将自身推送到 GitHub_](https://benhoyt.com/writings/pygit/)
* [**Python**: _自己写一个 Git！_](https://wyag.thb.lt/)
* [**Python**: _ugit：通过自己构建 Git 学习 Git 内部原理_](https://www.leshenko.net/p/ugit/)
* [**Ruby**: _用 Ruby 重建 Git_](https://robots.thoughtbot.com/rebuilding-git-in-ruby)

#### 从零构建你自己的`内存分配器`

* [**C**: _Malloc 不是魔法——实现你自己的内存分配器_](https://medium.com/p/e0354e914402)
...
* [**F#**: _用 F# 构建神经网络：第一部分_](https://medium.com/data-science/building-neural-networks-in-f-part-1-a2832ae972e6)
* [**F#**: _用 F# 构建神经网络：第二部分_](https://medium.com/data-science/building-neural-networks-in-f-part-2-training-evaluation-5e3a68889da6)
* [**Go**: _用 Golang 构建多层感知机_](https://made2591.github.io/posts/neuralnetwork)
* [**Go**: _如何用 Go 构建简单人工神经网络_](https://sausheong.github.io/posts/how-to-build-a-simple-artificial-neural-network-with-go/)
* [**Go**: _从零用 Go 构建神经网络_](https://datadan.io/blog/neural-net-with-go)
* [**JavaScript / Java**: _神经网络——代码的本质_](https://www.youtube.com/playlist?list=PLRqwX-V7Uu6aCibgK1PTWWu9by6XFdCfh) [视频]
* [**JavaScript**: _为 JavaScript 开发者从零构建神经网络（第一部分——感知机）_](https://hackernoon.com/neural-networks-from-scratch-for-javascript-linguists-part1-the-perceptron-632a4d1fbad2)
* [**Python**: _11 行 Python 实现神经网络_](https://iamtrask.github.io/2015/07/12/basic-python-network/)
...
* [**Python**: _神经网络：从零到高手_](https://www.youtube.com/playlist?list=PLAqhIrjkxbuWI23v9cThsA9GvCAUhRvKZ)
* [**Python**: _SlowTorch：用 100% 纯 Python 从底层实现 PyTorch_](https://github.com/xames3/slowtorch)

#### 从零构建你自己的`操作系统`

* [**Assembly**: _编写一个微型 x86 启动加载器_](http://joebergeron.io/posts/post_two.html)
* [**Assembly**: _树莓派烘焙——操作系统开发_](http://www.cl.cam.ac.uk/projects/raspberrypi/tutorials/os/index.html)
* [**C**: _为简单计算机从零构建软硬件栈_](https://www.youtube.com/watch?v=ZjwvMcP3Nf0&list=PLU94OURih-CiP4WxKSMt3UcwMSDM3aTtX) [视频]
...
* [**C**: _Kernel 101——让我们编写一个内核_](https://arjunsreedharan.org/post/82710718100/kernel-101-lets-write-a-kernel)
* [**C**: _Kernel 201——让我们编写支持键盘和屏幕的内核_](https://arjunsreedharan.org/post/99370248137/kernel-201-lets-write-a-kernel-with-keyboard)
* [**C**: _从零为 ARM 构建最小多任务内核_](https://github.com/jserv/mini-arm-os)
* [**C**: _如何从零创建操作系统_](https://github.com/cfenollosa/os-tutorial)
* [**C**: _Malloc 教程_](https://danluu.com/malloc-tutorial/)
* [**C**: _攻击虚拟内存_](https://blog.holbertonschool.com/hack-the-virtual-memory-c-strings-proc/)
* [**C**: _使用 Linux 内核和树莓派学习操作系统开发_](https://github.com/s-matyukevich/raspberry-pi-os)
* [**C**: _为小白讲解操作系统开发_](https://medium.com/@lduck11007/operating-systems-development-for-dummies-3d4d786e8ac)
* [**C++**: _编写你自己的操作系统_](https://www.youtube.com/playlist?list=PLHh55M_Kq4OApWScZyPl5HhgsTJS9MZ6M) [视频]
* [**C++**: _编写启动加载器_](http://3zanders.co.uk/2017/10/13/writing-a-bootloader/)
* [**Rust**: _用 Rust 编写操作系统_](https://os.phil-opp.com/)
* [**Rust**: _添加 RISC-V Rust 操作系统教程_](https://osblog.stephenmarz.com/)
* [**(任意语言)**: _从零构建 Linux_](https://linuxfromscratch.org/lfs)
...
* [**JavaScript**: _物理引擎是如何工作的_](http://buildnewgames.com/gamephysics/)
* [**JavaScript**: _使用空间分区进行宽相碰撞检测_](http://buildnewgames.com/broad-phase-collision-detection/)
...
* [**Verilog**: _从闪烁灯到 RISC-V_](https://github.com/BrunoLevy/learn-fpga/tree/master/FemtoRV/TUTORIALS/FROM_BLINKER_TO_RISCV)

#### 从零构建你自己的`编程语言`

* [**(任意语言)**: _mal——打造一个 Lisp_](https://github.com/kanaka/mal#mal---make-a-lisp)
* [**Assembly**: _Jonesforth_](https://github.com/nornagon/jonesforth/blob/master/jonesforth.S)
* [**C**: _Baby 的第一个垃圾收集器_](http://journal.stuffwithstuff.com/2013/12/08/babys-first-garbage-collector/)
* [**C**: _构建你自己的 Lisp：用 C 学习并在 1000 行代码中构建你自己的编程语言_](http://www.buildyourownlisp.com/)
* [**C**: _用 C 编写简单的垃圾收集器_](http://maplant.com/gc.html)
* [**C**: _能解释自身的 C 解释器_](https://github.com/lotabout/write-a-C-interpreter)
* [**C**: _Jack Crenshaw 《让我们构建编译器》的 C 和 x86 版本_](https://github.com/lotabout/Let-s-build-a-compiler)
* [**C**: _从零构建编译器的旅程_](https://github.com/DoctorWkt/acwj)
...
* [**C++**: _万花筒：使用 LLVM 实现编程语言_](https://llvm.org/docs/tutorial/MyFirstLanguageFrontend/index.html)
* [**F#**: _理解解析器组合子_](https://fsharpforfunandprofit.com/posts/understanding-parser-combinators/)
* [**Elixir**: _通过编写编译器揭开其神秘面纱_](https://www.youtube.com/watch?v=zMJYoYwOCd4) [视频]
* [**Go**: _超迷你编译器_](https://github.com/hazbo/the-super-tiny-compiler)
...
* [**Java**: _制作解释器：编程语言制作手册_](http://www.craftinginterpreters.com/)
* [**Java**: _创建 JVM 语言_](http://jakubdziworski.github.io/categories.html#Enkel-ref)
* [**JavaScript**: _超迷你编译器_](https://github.com/jamiebuilds/the-super-tiny-compiler)
* [**JavaScript**: _超迷你解释器_](https://github.com/keyanzhang/the-super-tiny-interpreter)
* [**JavaScript**: _Little Lisp 解释器_](https://maryrosecook.com/blog/post/little-lisp-interpreter)
* [**JavaScript**: _如何在 JavaScript 中实现编程语言_](http://lisperator.net/pltut/)
* [**JavaScript**: _让我们来写一个 Lisp_](https://idiocy.org/lets-go-write-a-lisp/part-1.html)
...
* [**Python**: _lisp.py：打造你自己的 Lisp 解释器_](http://khamidou.com/compilers/lisp.py/)
* [**Python**: _如何用 Python 编写 Lisp 解释器_](http://norvig.com/lispy.html)
...
* [**Racket**: _美丽的 Racket：如何用 Racket 创建你自己的编程语言_](https://beautifulracket.com/)
* [**Ruby**: _从零编写一个编译器_](https://www.destroyallsoftware.com/screencasts/catalog/a-compiler-from-scratch)
* [**Ruby**: _用 Ruby 从零编写 Markdown 编译器_](https://blog.beezwax.net/2017/07/07/writing-a-markdown-compiler/)
...
* [**C**: _正则表达式匹配可以既简单又快速_](https://swtch.com/~rsc/regexp/regexp1.html)
* [**Go**: _如何从零构建正则表达式引擎_](https://rhaeguard.github.io/posts/regex)
...
* [**Perl**: _正则表达式是如何工作的_](https://perl.plover.com/Regex/article.html)
...
* [**CSS**: _用 CSS 实现搜索引擎_](https://stories.algolia.com/a-search-engine-in-css-b5ec4e902e97)
...
* [**Python**: _使用 TF-IDF 找出文本中的重要词汇_](https://stevenloria.com/tf-idf/)
...
* [**Rust**: _用 Rust 构建你自己的 Shell_](https://www.joshmcguigan.com/blog/build-your-own-shell-rust/)

#### 从零构建你自己的`模板引擎`

* [**JavaScript**: _仅用 20 行代码实现 JavaScript 模板引擎_](http://krasimirtsonev.com/blog/article/Javascript-template-engine-in-just-20-line)
* [**JavaScript**: _理解 JavaScript 微模板_](https://medium.com/wdstack/understanding-javascript-micro-templating-f37a37b3b40e)
* [**Python**: _方法论：用 Python 构建玩具模板引擎_](http://alexmic.net/building-a-template-engine/)
* [**Python**: _模板引擎_](http://aosabook.org/en/500L/a-template-engine.html)
* [**Ruby**: _如何用不到 30 行代码编写模板引擎_](http://bits.citrusbyte.com/how-to-write-a-template-library/)

#### 从零构建你自己的`文本编辑器`

* [**C**: _构建你自己的文本编辑器_](https://viewsourcecode.org/snaptoken/kilo/)
* [**C++**: _设计简单的文本编辑器_](http://www.fltk.org/doc-1.1/editor.html)
* [**Python**: _Python 教程：制作你自己的文本编辑器_](https://www.youtube.com/watch?v=xqDonHEYPgA) [视频]
...
* [**Python**: _在 Tensorflow 中使用深度学习构建人脸识别流水线_](https://hackernoon.com/building-a-facial-recognition-pipeline-with-deep-learning-in-tensorflow-66e7645015b8)
...
* [**Node.js**: _用 NodeJS Streams 从零编写 Web 服务器_](https://www.codementor.io/@ziad-saab/let-s-code-a-web-server-from-scratch-with-nodejs-streams-h4uc9utji)
...
* [**Python**: _用 Python 从零构建基础 HTTP 服务器_](http://joaoventura.net/blog/2017/python-webserver/)
* [**Python**: _用 Python 和 Flask 实现 RESTful Web API_](http://blog.luisrei.com/articles/flaskrest.html)
* [**Ruby**: _用 Ruby 从零构建简单的 WebSocket 服务器_](http://blog.honeybadger.io/building-a-simple-websockets-server-from-scratch-in-ruby/)

#### 其他

* [**(任意语言)**: _从与非门到俄罗斯方块：从第一原理构建现代计算机_](http://nand2tetris.org/)
* [**(任意语言)**: _build-your-own-x-vibe-coding：适配 vibe coding 的 BYOX 风格教程_](https://github.com/inFaaa/build-your-own-x-vibe-coding)
...
* [**C**: _Sol——从零构建 MQTT 代理_](https://codepr.github.io/posts/sol-mqtt-broker)
* [**C++**: _200 美元构建你自己的 VR 头显_](https://github.com/relativty/Relativ)
* [**C++**: _X 窗口管理器的工作原理及如何编写一个_](https://seasonofcode.com/posts/how-x-window-managers-work-and-how-to-write-one-part-i.html)
* [**C++**: _编写 Linux 调试器_](https://blog.tartanllama.xyz/writing-a-linux-debugger-setup/)
* [**C++**: _64k intro 是如何制作的_](http://www.lofibucket.com/articles/64k_intro.html)
...
* [**C#**: _用 C# 和 GLSL 从零加载并渲染 3D 骨骼动画_](https://www.seanjoflynn.com/research/skeletal-animation.html)
* [**Clojure**: _构建拼写检查器_](https://bernhardwenzel.com/articles/clojure-spellchecker/)
* [**Go**: _用 100 行 Golang 代码构建简单终端模拟器_](https://ishuah.com/2021/03/10/build-a-terminal-emulator-in-100-lines-of-go/)
* [**Go**: _让我们创建一个简单的负载均衡器_](https://kasvith.me/posts/lets-create-a-simple-lb-go/)
* [**Go**: _从零实现视频编码_](https://github.com/kevmo314/codec-from-scratch)
...
* [**JavaScript**: _通过构建 Promise 学习 JavaScript Promise_](https://levelup.gitconnected.com/understand-javascript-promises-by-building-a-promise-from-scratch-84c0fd855720)
* [**JavaScript**: _从零实现 Promise（TDD 方式）_](https://www.mauriciopoppe.com/notes/computer-science/computation/promises/)
...
* [**JavaScript**: _10 分钟构建你自己的广告拦截器_](https://levelup.gitconnected.com/building-your-own-adblocker-in-literally-10-minutes-1eec093b04cd)
...
* [**Node.js**: _用 40 行 Node.js 代码构建静态网站生成器_](https://www.webdevdrops.com/en/build-static-site-generator-nodejs-8969ebe34b22/)
* [**Node.js**: _从零用 Node.js 构建简单的单点登录（SSO）服务器和解决方案_](https://codeburst.io/building-a-simple-single-sign-on-sso-server-and-solution-from-scratch-in-node-js-ea6ee5fdf340)
* [**Node.js**: _如何用 Node 创建真实世界的 Node CLI 应用_](https://medium.freecodecamp.org/how-to-create-a-real-world-node-cli-app-with-node-391b727bbed3)
* [**Node.js**: _用 Node.js 构建 DNS 服务器_](https://engineerhead.github.io/dns-server/)
* [**Node.js**: _用 Node.js 和 Y.js 构建同步引擎_](https://greenvitriol.com/posts/sync-engine-for-everyone)
* [**PHP**: _用 PHP 从零编写你自己的 MVC_](https://chaitya62.github.io/2018/04/29/Writing-your-own-MVC-from-Scratch-in-PHP.html)
* [**PHP**: _制作你自己的博客_](https://ilovephp.jondh.me.uk/en/tutorial/make-your-own-blog)
* [**PHP**: _不使用框架的现代 PHP_](https://kevinsmith.io/modern-php-without-a-framework)
...
* [**Python**: _如何在 5 分钟内构建超酷的移动文档扫描仪_](https://www.pyimagesearch.com/2014/09/01/build-kick-ass-mobile-document-scanner-just-5-minutes/)
* [**Python**: _持续集成系统_](http://aosabook.org/en/500L/a-continuous-integration-system.html)
* [**Python**: _Python 推荐系统初学者教程_](https://www.datacamp.com/community/tutorials/recommender-systems-python)
* [**Python**: _用 Scikit-learn 编写短信垃圾检测器_](https://medium.com/@kopilov.vlad/detect-sms-spam-in-kaggle-with-scikit-learn-5f6afa7a3ca2)
* [**Python**: _Python 中简单的基于内容的推荐引擎_](http://blog.untrod.com/2016/06/simple-similar-products-recommendation-engine-in-python.html)
* [**Python**: _用 Python 中的 LSTM 进行股票市场预测_](https://www.datacamp.com/community/tutorials/lstm-python-stock-market)
* [**Python**: _在 Tensorflow 中构建简单的生成对抗网络（GAN）_](https://blog.paperspace.com/implementing-gans-in-tensorflow/)
...
* [**Ruby**: _真实世界中的计步器_](http://aosabook.org/en/500L/a-pedometer-in-the-real-world.html)
* [**Ruby**: _用 Ruby 创建 Linux 桌面应用程序_](https://iridakos.com/tutorials/2018/01/25/creating-a-gtk-todo-application-with-ruby)
...
* [**TypeScript**: _迷你包管理器：了解 npm 或 Yarn 的工作原理_](https://github.com/g-plane/tiny-package-manager)

## 贡献
* 欢迎提交，请发送 PR 或[创建 Issue](https://github.com/codecrafters-io/build-your-own-x/issues/new)
* 请在 [待审核提交](https://github.com/codecrafters-io/build-your-own-x/issues) 中留下评论和"reactions"来帮助我们审核

## 起源与许可证

[![CC0](https://mirrors.creativecommons.org/presskit/buttons/88x31/svg/cc-zero.svg)](https://creativecommons.org/publicdomain/zero/1.0/)

本仓库由[众多贡献者](https://github.com/codecrafters-io/build-your-own-x/graphs/contributors)共同完成。由 [Daniel Stefanovic](https://github.com/danistefanovic) 创建，现由 [CodeCrafters, Inc.](https://codecrafters.io) 维护。在法律允许的范围内，[CodeCrafters, Inc.](https://codecrafters.io) 已放弃对本作品的所有版权及相关权利。
